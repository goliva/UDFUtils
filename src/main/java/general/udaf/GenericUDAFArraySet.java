 ...
 */
@Description(name = "collect_array", value = "_FUNC_(x) - Returns a set of objects with duplicate elements eliminated")
public class GenericUDAFArraySet extends AbstractGenericUDAFResolver {

  static final Log LOG = LogFactory.getLog(GenericUDAFArraySet.class.getName());
  
  public GenericUDAFArraySet() {
  }
